...
| <div id="nodemargins">nodeMargins?</div> |  Provides margin for nodes, i.e., a rectangular area around a specific node considered during the layout. | <pre>(node: TNodeData) =&gt; [NodeMargins](nodemargins)</pre> |
...
| <div id="ports">ports?</div> |  Provides information about how an edge connects to its nodes. | <pre>[PortDataProvider](portdataprovider)&lt;TEdgeData&gt;</pre> |
