...
|---|---|---|
| <div id="childorder">childOrder?</div> |  Provides an order for the given edges in which the edges are arranged at a node. | <pre>[ChildOrderDataProvider](childorderdataprovider)&lt;TNodeData,TEdgeData&gt;</pre> |
